# Kubernates
- [Kubernetes](https://kubernetes.io), also known as **K8s**, is an OPEN-SOURCE system for automating deployment, [scaling](https://github.com/Anshul619/HLD-System-Designs/blob/main/4_Scalability), and management of containerized applications. 
...
| Use Case                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------|
| [Zomato](https://github.com/Anshul619/HLD-System-Designs/blob/main/0_UseCaseDesigns/FoodOrderingZomatoSwiggy/Readme.md) |
...
|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Control Plane (Master node) | [The control plane](https://kubernetes.io/docs/concepts/overview/components/) manages the worker nodes and the pods in the cluster.<br/>- In production environments, the control plane usually runs across multiple computers and a cluster usually runs multiple nodes, providing [fault-tolerance and high availability](https://github.com/Anshul619/HLD-System-Designs/blob/main/5_HighAvailability/Readme.md).<br/>- [Nodes with controlplane]((https://kubernetes.io/docs/concepts/overview/components/)) role run the K8s master components (excluding [etcd](../../5_ClusterCoordination/etcd.md), as its separate role).                                                   |
...
| etcd                  | [etcd](../../5_ClusterCoordination/etcd.md) is used for [Configuration Store & Service Discovery](https://github.com/Anshul619/HLD-System-Designs/blob/main/3_MicroServices/2_ServiceRegistry&Discovery).<br/>- etcd is a [Consistent](https://github.com/Anshul619/HLD-System-Designs/blob/main/1_Databases/4_Consistency-Replication/Readme.md) and [highly-available key value store](https://github.com/Anshul619/HLD-System-Designs/blob/main/5_HighAvailability/Readme.md) used as Kubernetes backing store for all cluster data. |
...
- [KOPS](https://kops.sigs.k8s.io/) offers a one-stop solution for deploying [Kubernetes cluster]() with [Amazon Web Services](https://github.com/Anshul619/AWS-Services/tree/main).
- It is an open source tool designed to make installation of secure, [highly available clusters](https://github.com/Anshul619/HLD-System-Designs/blob/main/5_HighAvailability/Readme.md) easy and automatable.
